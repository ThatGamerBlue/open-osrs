...
object MultiplierFinderKt {

    fun transform(dir: Path, dir2: Path) {
        var klasses: Collection<ClassNode> = readJar(dir)
        ...
        MultiplierCompanion.decoders = multipliers.decoders.toSortedMap()

        //mapper.writeValue(dir.resolve( "mult.json").toFile(), )
